...
import styles from "../assets/css/UserInfoLogout.module.css";
...
const UserInfoLogout = () => {
  const { user, setIsLogedIn } = useContext(LogedIn);
        ...
        axios
          ...
          .catch(() => {
            ...
            Swal.fire({
              ...
              text: "cannot logout try agan later ",
              icon: "error",
            });
          });
      }
  ...
  return (
    <div className={styles.page}>
      ...
      {error && <Notifcation message={"something went wrong"} />}
    </div>
  );
};
